 ...
 * Instead, change the Calendars/Event.js file.
 *
 * @module Calendars
 */
...
Base.table = function (withoutDbName) {
	if (Q.Config.get(['Db', 'connections', 'Calendars', 'indexes', 'Event'], false)) {
		return new Db.Expression((withoutDbName ? '' : '{{dbname}}.')+'{{prefix}}event');
	} else {
		var conn = Db.getConnection('Calendars');
		var prefix = conn.prefix || '';
		var tableName = prefix + 'event';
 ...
 * @type string
 */
Base.prototype.className = "Calendars_Event";
 ...
 * @throws {Error} An exception is thrown if 'value' is not string or is exceedingly long
 */
Base.prototype.beforeSet_interests = function (value) {
		if (value == undefined) return value;
		if (value instanceof Db.Expression) return value;
		if (typeof value !== "string" && typeof value !== "number")
			throw new Error('Must pass a String to '+this.table()+".interests");
		if (typeof value === "string" && value.length > 2046)
			throw new Error('Exceedingly long value being assigned to '+this.table()+".interests");
		return value;
};
	 ...
	 * @return {integer}
	 */
Base.prototype.maxSize_interests = function () {
	 ...
	 * @return {array} [[typeName, displayRange, modifiers, unsigned], isNull, key, default]
	 */
Base.column_interests = function () {

return [["varchar","2046","",false],true,"",null];
};
 ...
 * @throws {Error} An exception is thrown if 'value' is not string or is exceedingly long
 */
Base.prototype.beforeSet_location = function (value) {
		if (value == undefined) return value;
		if (value instanceof Db.Expression) return value;
		if (typeof value !== "string" && typeof value !== "number")
			throw new Error('Must pass a String to '+this.table()+".location");
		if (typeof value === "string" && value.length > 1023)
			throw new Error('Exceedingly long value being assigned to '+this.table()+".location");
		return value;
};
	 ...
	 * @return {integer}
	 */
Base.prototype.maxSize_location = function () {
