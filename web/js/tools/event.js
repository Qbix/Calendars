...
'<div class="Calendars_event_curtain">' +
	...
	'{{/if}}' +
	'data-streams-preview=\'{"publisherId":"{{stream.fields.publisherId}}","streamName":"{{stream.fields.name}}", "cacheBust": false, "closeable": false, "imagepicker": {"cacheBust": false, "showSize": "500x333", "save": "Calendars/event", "saveSizeName": "Calendars/event"}}\'>' +
	'</div></div>' +
	'{{#if show.hosts}}' +
