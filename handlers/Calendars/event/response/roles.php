...
/**
 * This handler read and return roles of selected user
 * @class Calendars event roles
 * @param {array} $options
 * @param {string} $userId The user id to read labels from
 * @param {string} $publisherId Event publisher Id
 * @param {string} $streamName Event stream name
 * @return array
 */
function Calendars_event_response_roles($options)
{
	...
	return $participant->getExtra('role');
}